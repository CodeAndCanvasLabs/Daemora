...
async function handleDoctor() {
  ...
  // 2. HTTP channel disabled (no unauthenticated /chat endpoint)
  ...
  if (hasAllowedPaths || hasDockerSandbox) {
    pass("Filesystem sandbox active");
  } else {
    warn("Filesystem sandbox not active", "Agent can access any file. Set ALLOWED_PATHS or SANDBOX_MODE=docker");
  }

  // 6. Daily cost limit set
