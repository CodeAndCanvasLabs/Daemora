...
Create, track, and monitor tasks with parent-child hierarchy. Tasks appear in the UI.
- createTask: paramsJson {"title":"...","description":"...","status":"pending|in_progress"}
- updateTask: paramsJson {"taskId":"...","status":"completed|failed","result":"..."}
- listTasks: paramsJson {"status":"running","parentTaskId":"..."} - filter by status or parent
- getTask: paramsJson {"taskId":"..."} - full details including child tasks
